...
@section('content')
                        ...
                        <div class="p-3 p-sm-3 p-md-4 p-lg-5">
                            <div class="text-center mt-3 mb-5">
                                <h1 class="fw-bolder text-primary">
                                    <img src="{{ asset('/assets/images/img/logo.png') }}" style="margin: 0 auto; width: 100px; height: auto; display: block;" id="logo" alt="">
                                </h1>
                            </div>
                            ...
                            <form action="" method="get" autocomplete="off" class="col-md-8 m-auto">
                                <div class="mb-3 text-center">
                                    ...
                                    <input type="text" name="idno" id="idno" class="form-control text-uppercase lg:text-right" style="direction: rtl" placeholder="ת.ז." autofocus required>
                                </div>
                                <div class="row g-2">
    ...
    <div class="position-fixed p-3 d-flex justify-content-center align-items-cente" style="z-index: 9; left: 0; right: 0; bottom: 0;">
        <div id="myToast" class="toast hide" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="true" data-bs-delay="5000">
          <div class="toast-header d-flex flex-row-reverse justify-content-between">
            <strong class="">הודעת מערכת</strong>
            <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
          </div>
          <div class="toast-body">
            <p> 
                <span id="greetings">שלום, </span>
