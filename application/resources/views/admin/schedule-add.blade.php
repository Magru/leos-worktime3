            ...
            <div class="card-body">
                ...
                <div class="row g-2">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="intime" value="" class="timepicker form-control" placeholder="00:00" required>
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="outime" class="form-label">{{ __("Off Time") }}</label>
                        <input type="text" name="outime" value="" class="timepicker form-control" placeholder="00:00">
                    </div>
                </div>

                <div class="mb-3">
                    <label for="datefrom" class="form-label">{{ __("From") }}</label>
                    <input type="text" name="datefrom" value="" class="airdatepicker form-control" placeholder="DD-MM-YYYY" required>
                </div>

                <div class="mb-3">
                    <label for="dateto" class="form-label">{{ __("Until") }}</label>
                    <input type="text" name="dateto" value="" class="airdatepicker form-control" placeholder="DD-MM-YYYY" required>
                </div>
