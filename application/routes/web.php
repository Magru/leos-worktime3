    ...
    Route::middleware(['checkstatus'])->group(function () {
        ...
        Route::middleware(['admin'])->group(function () {
            ...
            */
            ...
            Route::get('admin/attendance-average', [AttendanceController::class, 'index'])->name('emp-average');
            ...
            */
            ...
            Route::post('admin/leave/add', [LeaveController::class, 'store'])->name('admin-leave-store');
        ...
        Route::middleware(['employee'])->group(function () {
            ...
            */
            ...
            Route::post('personal/attendance', [PersonalAttendanceController::class, 'index']);
